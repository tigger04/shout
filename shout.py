...
class ShoutText(QTextEdit):
    def __init__(self, parent=None):
        ...
        self.font = QFont("Sudoers", 24)  # Set the font to "Sudoers" and size to 24 points
...
window = QMainWindow()
window.setWindowOpacity(0.8)  # Set the opacity to 0.8 (1.0 is fully opaque, 0.0 is fully transparent)
